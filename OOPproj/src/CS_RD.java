...
public class CS_RD {
    ...
    public static void run(){
        try{
            ...
            List<Question.Data> subList = qList.subList(14, 20);

            Collections.shuffle(subList);

            String[] choice = { "Discrete Maths Increasing Difficulty", "Discrete Maths Random",
                    "Computer Organization Increasing Difficulty", "Computer Organization Random", "Computer Science Increasing Difficulty",
                    "Who Wants to be a Millionaire!" };

            JOptionPane.showMessageDialog(null, "Welcome to the Computer Science Quiz", "Welcome", JOptionPane.PLAIN_MESSAGE);
